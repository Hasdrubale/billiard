...
Geo::Border::Border(double r1, double r2, double l, char type): r1_{r1}, r2_{r2}, l_{l}, type_{type}{}

double Geo::Border::r1() const{return r1_;}
double Geo::Border::r2() const{return r2_;}
double Geo::Border::l() const{return l_;}
char Geo::Border::type() const{return type_;}
